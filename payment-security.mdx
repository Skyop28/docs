...
![IMAGE PLACEHOLDER: Payment flow diagram showing user going to PayPal, entering card there, and Right Spot receiving only confirmation](https://ik.imagekit.io/awnish90/image45.png)
...
![Paypal's Diagram](https://ik.imagekit.io/awnish90/image45454.png)
